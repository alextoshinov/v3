...
class Login extends Front {
    ...
    public function register()
    {
        ...
        \CI::form_validation()->set_rules('firstname', 'lang:account_firstname', 'trim|max_length[32]');
        \CI::form_validation()->set_rules('lastname', 'lang:account_lastname', 'trim|max_length[32]');
        ...
        \CI::form_validation()->set_rules('phone', 'lang:account_phone', 'trim|max_length[32]');
