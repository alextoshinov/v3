                        ...
                        <div class="col-md-5 col-md-offset-7">
                            <div class="input-group">                                
                               <select id="optionTypes" class="form-control">
                                    ...
                                    <option value="colorlist"><?php echo lang('colorlist');?></option>
                                    <option value="sizelist"><?php echo lang('sizelist');?></option>
                                </select>
...
<script type="text/template" id="optionValueTemplate">
    <style>.form-control {background-color:none !important;}</style>
    ...
    <div class="optionValuesForm">
        <div class="row">
            ...
            <div class="col-md-2"><input type="text" class="form-control input-sm" name="option[{{id}}][values][{{valId}}][name]" value="{{name}}" /></div>
            <div class="col-md-1"><input type="text" class="form-control input-sm" name="option[{{id}}][values][{{valId}}][value]" value="{{value}}" /></div>
            ...
            <div class="col-md-2">
                <select id="colorSelector" class="form-control input-sm" name="option[{{id}}][values][{{valId}}][color]">
                    <?php foreach($all_colors as $c):?>        
                    <option class="colorOptions" style="color:#FFFFFF;background-color:<?php echo $c->color;?>" value="<?php echo $c->color;?>,<?php echo $c->name;?>,{{id}},{{valId}}" data-color-selected="{{color}}" data-color="<?php echo $c->color;?>"><?php echo $c->name;?></option>
                    <?php endforeach; ?>
                </select>
...
$(document).ready(function() {
    ...
    $("body").on("change", "#colorSelector", function () {
        ...
        $('input[name="option[' + colorArr[2] + '][values][' + colorArr[3] + '][name]"]').val(colorArr[1]);
    });
    //
    $(".sortable").sortable();
...
function addOption(type, name, isText, required, values)
{
    ...
    $.each(values, function(key,val) {
        addOptionValue(optionCount, val.name, val.value, val.weight, val.price, val.color, val.limit, isText);
    });
...
function checkSelect() {
    ...
    $("#colorSelector option").each(function () {        
        if($(this).attr('data-color') === $(this).attr('data-color-selected')) {
...
//
function addOptionValue(id, name, value, weight, price, color, limit, isText)
{
