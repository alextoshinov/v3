    ...
    <div class="row">
        <div class="col-sm-8">
            ...
            <?php foreach($charges['products'] as $product):
                ...
                if(!empty($product->images[0]))
                {
                    ...
                    $photo = '<img src="'.base_url('uploads/images/full/'.$primary['filename']).'" width="137" height="183"/>';
                }
                ?>
                                ...
                                <div class="orderItemDescription">
                                    ...
                                    if(isset($order->options[$product->id])):
                                        ...
                                        foreach($order->options[$product->id] as $option):?>
                                            <div class="orderItemOption"><strong><?php echo ($product->is_giftcard) ? lang('gift_card_'.$option->option_name) : $option->option_name;?> :</strong> <?php echo($option->price > 0)?'['.format_currency($option->price).']':'';?> <?php echo $option->name;?></div>
                                        <?php endforeach;
            ...
            <?php endforeach;?>
                ...
                <div class="cartSummaryTotals">
                    ...
                    <div class="row">
                        <div class="col-sm-8" data-cols="2/3" data-medium-cols="2/3" data-small-cols="2/3">
                            <div class="cartSummaryTotalsKey pull-right"><strong><?php echo lang('grand_total');?>:</strong></div>
                        </div>

                        <div class="col-sm-4" data-cols="1/3" data-medium-cols="1/3" data-small-cols="1/3">
                            <div class="orderTotalsValue"><strong><?php echo format_currency($order->total);?></strong></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-4" >
            <div class="orderAddresses">
                <div class="orderAddressTitle"><h3><?php echo lang('shipping_address');?></h3></div>
                ...
                <div class="orderAddressTitle"><h3><?php echo lang('billing_address');?></h3></div>
                <div class="orderAddress">
                <?php echo format_address([
                ...
                <div class="orderAddressTitle"><h3><?php echo lang('payment_information');?></h3></div>
                <div class="orderAddress">
