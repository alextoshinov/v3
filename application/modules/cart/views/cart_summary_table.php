        ...
        <tfoot>
            ...
            <tr class="cartPromotions">
                        <td colspan="4" class="text-right">
                            ...
                            <a class="btn btn-main" type="button" onclick="submitCoupon()"><i class="icon-plus"></i></a>
                            </form>
                        </td>
                        <td colspan="2" class="text-left">
                            ...
                            <a class="btn btn-main" type="button" onclick="submitGiftCard()"><i class="icon-plus"></i></a>
                            </form>
                        </td>
            </tr>        
        </tfoot>
