...
<title>Vandona<?php echo (isset($page_title))?' :: '.$page_title:''; ?></title>
...
<link href="<?php echo base_url('assets/css/bootstrap-colorselector.css');?>" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="<?php echo base_url('assets/js/bootstrap-colorselector.js');?>"></script>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url('admin');?>">Админ панел на Vandona</a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="<?php echo site_url('admin/colors');?>"><?php echo lang('common_colors'); ?></a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="<?php echo site_url('admin/subscriptions');?>"><?php echo 'Запитвания'; ?></a></li>
